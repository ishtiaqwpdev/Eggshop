...
$et_home_hero_frame_width     = 16;
$et_home_hero_frame_height    = 10;
$et_home_hero_poster_fill_color = '#ff9616';
/* Dominant edge tone behind video when it letterboxes inside the shared frame. */
$et_home_hero_video_letterbox_color = '#ff9616';
                ...
                <div class="et-home__hero-video-stack">
                    <div class="et-home__hero-video-frame">
                        <div
                            ...
                            style="--et-home-hero-frame-aspect-ratio: <?php echo (int) $et_home_hero_frame_width; ?> / <?php echo (int) $et_home_hero_frame_height; ?>; --et-home-hero-poster-fill-color: <?php echo esc_attr( $et_home_hero_poster_fill_color ); ?>; --et-home-hero-video-letterbox-color: <?php echo esc_attr( $et_home_hero_video_letterbox_color ); ?>;"
                        >
                            <video
