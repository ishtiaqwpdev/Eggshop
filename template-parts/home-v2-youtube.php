            ...
            <div class="et-home__youtube-layout">
                ...
                <ul class="et-home__youtube-list">
                    <?php foreach ( $et_home_youtube_list as $index => $video ) : ?>
                        ...
                        $is_active = 0 === $index;
                        ?>
                        <li class="et-home__youtube-list-item<?php echo $is_active ? ' is-active' : ''; ?><?php echo $index >= 3 ? ' et-home__youtube-list-item--mobile-hidden' : ''; ?>">
                            <a
                ...
                <?php
                set_query_var( 'et_youtube_subscribe_wrapper', 'et-home__youtube-subscribe et-home__youtube-subscribe--desktop' );
